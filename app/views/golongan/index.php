...
<html lang="en" class="ms-5 me-5">
  ...
  <nav class="navbar navbar-expand-lg bg-primary bg-gradient">
    ...
    <a href="<?php echo URL; ?>/golongan/create" class="btn btn-dark mb-2 float-end">Tambah Golongan</a>
            ...
            <?php
                foreach($data as $row){ ?>
                    <tr>
                        ...
                        <td class="text-center" style="width:50px;"><a href="<?= URL; ?>/golongan/edit/<?= $row['gol_id']; ?>" class="badge text-bg-success text-decoration-none">Edit</a></td>
