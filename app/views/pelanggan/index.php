...
<html lang="en" class="ms-5 me-5">
  ...
  <nav class="navbar navbar-expand-lg bg-primary bg-gradient">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?php echo URL; ?>/dashboard"><img src="<?php echo URL; ?>/layouts/assets/img/logo.png" alt="" width="100" height="100"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link text-light fs-4" aria-current="page" href="<?php echo URL; ?>/pelanggan">Pelanggan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light fs-4" href="<?php echo URL; ?>/golongan">Golongan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light fs-4" href="<?php echo URL; ?>/user">User</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light fs-4" href="<?php echo URL; ?>/user/logout">Logout</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <a href="<?php echo URL; ?>/pelanggan/create" class="btn btn-dark mb-2 float-end">Tambah Pelanggan</a>
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td class="text-center" style="width:50px;"><a href="<?= URL; ?>/pelanggan/edit/<?= $row['pel_id']; ?>" class="badge text-bg-success text-decoration-none">Edit</a></td>
